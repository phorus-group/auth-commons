...
/**
 * Creates access and refresh tokens in the configured [token format][group.phorus.auth.commons.config.TokenFormat].
 *
 * The concrete serialization (JWS, JWE, or nested JWE) is determined by the
 * `group.phorus.security.jwt.token-format` property and is transparent to callers.
 *
 * This bean is registered in [group.phorus.auth.commons.config.AuthMode.STANDALONE] and
 * [group.phorus.auth.commons.config.AuthMode.IDP_BRIDGE] modes.
 */
